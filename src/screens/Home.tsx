  ...
  return (
    <div className="relative mx-auto flex min-h-screen w-[393px] flex-col bg-[#F8F8F8]">
      <main className="flex flex-1 flex-col overflow-y-auto px-4">
        ...
        {isRoomMenuOpen && (
          <div className="absolute right-4 top-[72px] z-20 flex w-[124px] flex-col overflow-hidden rounded-[2px] bg-white shadow-[0_12px_24px_rgba(0,0,0,0.12)]">
            <button
              type="button"
              onClick={() => {
              ...
              className="inline-flex w-full items-center justify-start gap-2.5 bg-white px-2 py-2.5 text-left font-['Roboto'] text-xs font-semibold leading-4 text-[#00CE76]"
            >
              {"\uBC29\uB9CC\uB4E4\uAE30"}
            </button>
            <button
